...
const CompletionsSpefic = ({ headerParameters }) => {
  ...
  const options = {
    ...
    "body": JSON.stringify({
      "model": model,
      "messages": [{role: "system",content: "You are a helpful assistant"}, {role: "user", content: inputTextCustom}],
        ...
        <div className="card p-5 shadow bg-light rounded" >
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              <textarea name="input" id="input" cols="30" rows="5" className="form-control" placeholder="Enter your prompt text here..."
            ...
            <div className="form-group my-3">
              ...
              <div className="row mt-3">
                ...
                <div className="col-sm-6">
                  Temperature(0–1) <input type="number" className="form-control" name="temperature" min="0" max="1" step="0.01"
            ...
            <div className="form-group">
              <textarea name="result" id="result" cols="30" rows="5" className="form-control" placeholder="Result will be shown here..." readOnly></textarea>
            </div>
          </form>
        </div>
      </div>
