...
const CompletionsGeneric = ({ headerParameters }) => {
  ...
  let placeholder = "Classify the Text’s label as positive, neutral, or negative.\nText:1. I loved this course! It was an interactive and helpful learning experience.\nText:2. I hate movies, books are better\nText:3. I enjoy reading, although movies are fun as well\nSentiment:";
  ...
  if (data) {
    if (status === 200) {
      console.log("This is the data", data.choices[0].message.content)
          ...
          <form onSubmit={(e) => handleSubmit(e)}>
            ...
            <div className="form-group my-3">
              <div className="row">
                ...
                <div className="col-sm-4">
                  Max. Length <input type="number" className="form-control" name="length" min="1" max="4000" step="1"
